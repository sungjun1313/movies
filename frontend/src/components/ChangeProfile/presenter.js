...
const ChangeProfile = (props) => (
  <div className={styles.container}>
    ...
    <form onSubmit={props.handleSubmit}>
      <input className={styles.inputStyle} type="text" placeholder="이름" onChange={props.handleInputChange} name="name" value={props.nameValue ? props.nameValue : props.name} required />
      <input className={styles.inputStyle} type="email" placeholder="이메일" onChange={props.handleInputChange} name="email" value={props.emailValue ? props.emailValue : props.email} required />
...
ChangeProfile.propTypes = {
  ...
  profile_imageValue: PropTypes.object,
